# Generated by Powerlevel10k configuration wizard on 2020-09-25 at 16:28 IST.
...
# flat tails, 1 line, compact, many icons, concise, instant_prompt=quiet.
...
() {
  ...
  # typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND="mediumspringgreen"
  # typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND="lightgoldenrod1"
  # typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND="mediumspringgreen"
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubecolor|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|k|kns|kcx'
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND='white'
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='e|p.*'
  # Custom icon.
